<script>
  import { coapplicantRace4, NoCoApp } from './../../stores.js';
...
<DataFieldFormat>
  ...
  <span slot="helpers">
    ...
    <!-- <QualityErrors errors="1" idName="Race4QualityErrors" errorsHTML="" />
    <ValidityErrors errors="2" idName="Race4ValidityErrors" errorsHTML="" /> -->
  </span>
  <span slot="input">
