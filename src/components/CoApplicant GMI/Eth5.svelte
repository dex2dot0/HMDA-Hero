<script>
  import { coapplicantEth5, NoCoApp } from './../../stores.js';
...
<DataFieldFormat>
  ...
  <span slot="helpers">
    ...
    <!-- <QualityErrors errors="1" idName="Eth5QualityErrors" errorsHTML="" />
    <ValidityErrors errors="2" idName="Eth5ValidityErrors" errorsHTML="" /> -->
  </span>
  <span slot="input">
