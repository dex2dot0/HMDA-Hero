<script>
  import { coapplicantRace2, NoCoApp } from './../../stores.js';
...
<DataFieldFormat>
  ...
  <span slot="helpers">
    ...
    <!-- <QualityErrors errors="1" idName="Race2QualityErrors" errorsHTML="" />
    <ValidityErrors errors="2" idName="Race2ValidityErrors" errorsHTML="" /> -->
  </span>
  <span slot="input">
