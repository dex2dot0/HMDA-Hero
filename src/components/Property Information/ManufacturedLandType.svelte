<script>
  import { manufacturedPropertyInterest } from './../../stores.js';
...
<DataFieldFormat>
  ...
  <span slot="helpers">
    <RegLink
      regUrl="https://www.consumerfinance.gov/rules-policy/regulations/1003/4/#a-30" />
    <QualityErrors errors="1" idName="MFLandTypeQualityErrors" errorsHTML="" />
    <ValidityErrors
      errors="2"
      idName="MFLandTypeValidityErrors"
      errorsHTML="" />
  </span>
  <span slot="input">
    <!-- svelte-ignore a11y-no-onchange-->
    <select
      class="{$manufacturedPropertyInterest > 0
