...
<DataFieldFormat>
  ...
  <span slot="helpers">
    <RegLink regUrl="hhttps://www.consumerfinance.gov/rules-policy/regulations/1003/4/#a-29"/>
    <QualityErrors errors=1 idName="MFPropertyTypeQualityErrors" errorsHTML=""/>
    <ValidityErrors errors=2 idName="MFPropertyTypeValidityErrors" errorsHTML=""/>
  </span>
  <span slot="input">
