<script>
  import { constructionMethod } from './../../stores.js';
...
<DataFieldFormat>
  ...
  <span slot="helpers">
    <RegLink
      regUrl="https://www.consumerfinance.gov/rules-policy/regulations/1003/4/#a-5" />
    <QualityErrors
      errors="1"
      idName="constructionMethodQualityErrors"
      errorsHTML="" />
    <ValidityErrors
      errors="2"
      idName="constructionMethodValidityErrors"
      errorsHTML="" />
  </span>
  <span slot="input">
