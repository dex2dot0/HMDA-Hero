...
<DataFieldFormat>
  <span slot="label">
    <label for="RaceFree3"> Free Form for Other Pacific Islander </label>
  </span>
  <span slot="helpers">
    <RegLink
  ...
  <span slot="input">
    ...
    {#if $applicantRace1 == 44 || $applicantRace2 == 44 || $applicantRace3 == 44 || $applicantRace4 == 44 || $applicantRace5 == 44}
      {#if $applicantRaceOther3 == ''}
