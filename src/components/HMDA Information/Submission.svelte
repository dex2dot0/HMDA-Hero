<script>
  import { submissionOfApplication } from './../../stores.js';
...
<DataFieldFormat>
  ...
  <span slot="helpers">
    <RegLink
      regUrl="https://www.consumerfinance.gov/rules-policy/regulations/1003/4/#a-33-i" />
    <!-- TODO
    Stripping out for now. Needs works.  -->
    <!-- <QualityErrors
      errors="1"
      idName="submissionOfApplicationQualityErrors"
      errorsHTML="" />
    <ValidityErrors
      errors="2"
      idName="submissionOfApplicationValidityErrors"
      errorsHTML="" /> -->
  </span>
  <span slot="input">
    <!-- svelte-ignore a11y-no-onchange-->
    <select
      class="{$submissionOfApplication > 0
