<script>
  import { denialReason4 } from './../../stores.js';
...
<DataFieldFormat>
  ...
  <span slot="helpers">
    ...
    <!-- <QualityErrors errors="1" idName="Denial4QualityErrors" errorsHTML="" />
    <ValidityErrors errors="2" idName="Denial4ValidityErrors" errorsHTML="" /> -->
  </span>
  <span slot="input">
    ...
    <select
      class="custom-select"
      id="Denial4"
      bind:value="{$denialReason4}"
      on:change="{denialReason4.change}">
      <option></option>
