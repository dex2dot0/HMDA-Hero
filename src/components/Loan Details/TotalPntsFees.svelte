...
<DataFieldFormat>
  ...
  <span slot="helpers">
    <RegLink regUrl="https://www.consumerfinance.gov/rules-policy/regulations/1003/4/#a-17"/>
    {#if $pointsFees !== 'NA'}
    ...
    <QualityErrors errors=1 idName="totalPntsFeesQualityErrors" errorsHTML=""/>
    <ValidityErrors errors=2 idName="totalPntsFeesValidityErrors" errorsHTML=""/>
  </span>
  <span slot="input">
    <input
      class="form-control"
