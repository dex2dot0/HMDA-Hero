...
<DataFieldFormat>
    ...
    <span slot="helpers">
      <RegLink regUrl="https://www.consumerfinance.gov/rules-policy/regulations/1003/4/#a-1-i-B"/>
      <Modal
      ...
      <ValidityErrors errors=2 idName="LoanNumberValidityErrors" errorsHTML=""/>
    </span>
    <span slot="input">
        <input
        class="form-control"
