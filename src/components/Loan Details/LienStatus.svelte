...
<DataFieldFormat>
  ...
  <span slot="helpers">
    <RegLink regUrl="https://www.consumerfinance.gov/rules-policy/regulations/1003/4/#a-14"/>
    <QualityErrors errors=1 idName="lienStatusQualityErrors" errorsHTML=""/>
    <ValidityErrors errors=2 idName="lienStatusValidityErrors" errorsHTML=""/>
  </span>
  <span slot="input">
