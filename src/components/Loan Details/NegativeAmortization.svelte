<script>
  import { negativeAm } from './../../stores.js';
...
<DataFieldFormat>
  ...
  <span slot="helpers">
    ...
    <QualityErrors errors="1" idName="negAmQualityErrors" errorsHTML="" />
    <ValidityErrors errors="2" idName="negAmValidityErrors" errorsHTML="" />
  </span>
  <span slot="input">
