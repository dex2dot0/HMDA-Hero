...
<DataFieldFormat>
  ...
  <span slot="helpers">
    <RegLink regUrl="https://www.consumerfinance.gov/rules-policy/regulations/1003/4/#a-20"/>
    {#if $lenderCredits !== 'NA'}
    ...
    <QualityErrors errors=1 idName="lenderCreditsQualityErrors" errorsHTML=""/>
    <ValidityErrors errors=2 idName="lenderCreditsValidityErrors" errorsHTML=""/>
  </span>
  <span slot="input">
    <input
      class="form-control"
