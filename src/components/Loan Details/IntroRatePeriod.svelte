...
<DataFieldFormat>
  ...
  <span slot="helpers">
    <RegLink regUrl="https://www.consumerfinance.gov/rules-policy/regulations/1003/4/#a-26"/>
    ...
    <QualityErrors errors=1 idName="introRatePeriodQualityErrors" errorsHTML=""/>
    <ValidityErrors errors=2 idName="introRatePeriodValidityErrors" errorsHTML=""/>
  </span>
  <span slot="input">
    <input
      class="form-control"
